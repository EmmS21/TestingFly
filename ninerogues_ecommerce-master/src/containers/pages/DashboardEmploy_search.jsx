        ...
        <>
          <div className="mt-4 sm:mt-0">
            <div className="font-medium text-indigo-600 hover:text-indigo-500">              
              <button onClick={changeStatus(product.transaction_id,product.status)}>Pedido Procesado</button>
            </div>
          </div>
        </>
      )
      ...
      if (product.status == "procesado") {
        return (
          <>
            <div className="mt-4 sm:mt-0">
              <div className="font-medium text-indigo-600 hover:text-indigo-500">
                <button onClick={changeStatus(product.transaction_id,product.status)}>Pedido Enviado</button>
              </div>
            </div>
          </>
        )
                    ...
                    <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
                      ...
                      <div className="mt-8">
                        ...
                        <div className="space-y-12">
                          {search_orders&&search_orders.map((product) => (
...
const mapStateToProps = state => ({
  ...
  search_orders : state.Orders.search_orders
