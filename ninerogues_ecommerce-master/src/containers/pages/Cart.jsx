...
const Cart = ({
    ...
    function shipping(){
        if (compare_amount <= 50 ){
            return 10
        }else if (compare_amount > 50 && compare_amount <=100) {
            return 15
        } else {
            return 20
        }
    ...
    return (
      ...
      <div className="max-w-2xl mx-auto pt-16 pb-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Items del carro de compras ({total_items})</h1>
