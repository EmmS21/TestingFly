...
const Checkout = ({
  ...
  let montoDelProducto = 1000;
  
const stripePromise = loadStripe('pk_test_51NTvopBXVtLgISPdNzx8V0hRplRJSPH0k44OrOVbID15DJS6c4TzE7iLLyRU77ZCtuX2lHa5EqLQOa1hNqFniLJ400UNKXLrVp');
  const buy = async e => {
    e.preventDefault();
  ...
  useEffect(() => {
    if (coupon && coupon !== null && coupon !== undefined)
      get_payment_total(1, coupon.name);
    else
      get_payment_total(1, 'default');
  }, [shipping_id, coupon]);
      ...
      return (
        <>
          ...
          <Elements stripe={stripePromise}>
            {/* Aquí puedes renderizar el componente StripeCheckout y cualquier otro componente que use useStripe() */}
            <StripeCheckout 
    ...
    <Layout>
      <div className="bg-white">
        <div className="max-w-2xl mx-auto pt-16 pb-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Pagar Orden</h1>
          <div className="mt-12 lg:grid lg:grid-cols-12 lg:gap-x-12 lg:items-start xl:gap-x-16">
            <section aria-labelledby="cart-heading" className="lg:col-span-7">
              <h2 id="cart-heading" className="sr-only">
                Items de tu carro de compras
              </h2>
