...
export const reset_password = (email) => async dispatch => {
    ...
    try{
        ...
        if (res.status === 204) {
            ...
            dispatch(setAlert('Correo enviado correctamente', 'green'));
        } else {
            dispatch({
            ...
            dispatch(setAlert('Error al enviar el correo', 'red'));
        }
    }
    catch(err){
        dispatch({
    ...
    if (new_password !== re_new_password) {
        ...
        try {
            ...
            if (res.status === 204) {
                ...
                dispatch(setAlert('Contraseña cambiada correctamente', 'green'));
            } else {
                dispatch({
                    type: RESET_PASSWORD_CONFIRM_FAIL
                });
                ...
                dispatch(setAlert('No se pudo cambiar la contraseña', 'red'));
            }
        } catch(err){
            dispatch({
                type: RESET_PASSWORD_CONFIRM_FAIL
...
export const logout = () => dispatch => {
    ...
    dispatch(setAlert('Sesión cerrada exitosamente', 'green'));
}