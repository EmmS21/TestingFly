...
const CartItem = ({
    ...
    useEffect(() => {
        ...
        const handleChange = (e) => {
          ...
          // Llama a la función onSubmit aquí
          onSubmit(event);
        };
        ...
        const fetchData = async () => {
            try {
                if (item.product.quantity >= item_count) {
                    ...
                    setAlert('No hay suficientes items', 'danger');
                }
                setRender(!render);
            } catch(err) {
        ...
        <li className="flex py-6 sm:py-10">
            ...
            <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                ...
                <form >
                    ...
                    {/* <button 
                        type="submit"
                        className=" ml-4 inline-block text-center bg-indigo-600 border border-transparent rounded-md py-1 px-2 font-medium text-white hover:bg-indigo-700">
