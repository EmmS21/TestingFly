...
DJOSER = {
    ...
    'SOCIAL_AUTH_ALLOWED_REDIRECT_URIS': ['https://ninerogues-ecommerce-master.fly.dev/google', 'https://ninerogues-ecommerce-master.fly.dev/facebook'],
    'SERIALIZERS': {
...
if not DEBUG:
    ALLOWED_HOSTS = [
    "ninerogues-ecommerce-master.fly.dev",
    "https://ninerogues-ecommerce-master.fly.dev",
    ]
    ...
    EMAIL_HOST_USER='loquenderoxd97@gmail.com'
    EMAIL_HOST_PASSWORD='gaguvscnhcwmrkte'
    EMAIL_PORT = 587
