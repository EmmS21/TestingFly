...
from .views import ProductDetailView, ListProductsView, ListSearchView, ListRelatedView, ListBySearchView,AdminProduct,NewProduct
...
urlpatterns = [
    ...
    path('admin-product/<productId>', AdminProduct.as_view()),
    path('new-product/', NewProduct.as_view()),
]